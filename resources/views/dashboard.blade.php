...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Selamat Datang di Klikdok </h1>
            <h2>Kesehatan lebih mudah, cukup klik dan temui dokter ahli.</h2>
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            ...
                            <div class="text-center">
                                <a href="#about" class="more-btn scrollto">Learn More <i
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="mt-4 icon-box mt-xl-0">
                                        ...
                                        <p>daftar secara online melalui website Klikdok . Anda dapat
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="mt-4 icon-box mt-xl-0">
                                        ...
                                        <p>Lihat jadwal dokter secara real-time dan pilih waktu yang sesuai dengan jadwal
                                            Anda.
                                            Kami menawarkan fleksibilitas untuk menyesuaikan janji temu Anda dengan jadwal
                                            dokter yang tersedia.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="mt-4 icon-box mt-xl-0">
                                        ...
                                        <p>Akses rekam medis Anda dengan mudah dan cepat melalui platform kami.
                                            Semua data kesehatan Anda disimpan dengan aman dan dapat diakses kapan saja
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <h3>Tentang Klikdok </h3>
                        <p>Klikdok  adalah pusat layanan kesehatan yang berdedikasi untuk memberikan perawatan yang terbaik
                            dan terpercaya bagi masyarakat. Kami mengutamakan kenyamanan dan kemudahan akses untuk semua
                            pasien kami.</p>
                        ...
                        <div class="icon-box">
                            ...
                            <p class="description">Komitmen kami adalah memberikan pelayanan kesehatan yang terbaik dengan
                                mengutamakan kebutuhan dan kenyamanan pasien. Kami selalu berusaha untuk meningkatkan
                        ...
                        <div class="icon-box">
                            ...
                            <p class="description">Kami menggunakan teknologi terkini untuk memastikan bahwa Anda
                                mendapatkan perawatan yang efisien dan tepat waktu. Dengan sistem online kami, Anda dapat
                                dengan mudah mengakses layanan kami kapan saja dan di mana saja</p>
                        </div>
                        ...
                        <div class="icon-box">
                            ...
                            <p class="description">Kami percaya bahwa setiap pasien adalah prioritas utama. Oleh karena itu,
                                kami berfokus pada memberikan pengalaman pelayanan yang ramah, profesional, dan penuh
                                perhatian.</p>
                        </div>
    ...
    <section id="gallery" class="gallery">
        <div class="container">
            <div class="section-title">
                <h2>Gallery</h2>
                <p>Di sini Anda dapat melihat berbagai foto dan momen berharga dari aktivitas dan layanan yang kami
                    tawarkan di Klikdok . Kami bangga dapat memberikan pelayanan terbaik kepada semua pasien kami.</p>
            </div>
        </div>
    ...
    <section id="contact" class="contact">
        <div class="container">
            <div class="section-title">
                <h2>Kontak</h2>
                <p>Hubungi kami untuk informasi lebih lanjut tentang layanan kami. Kami siap membantu Anda dengan segala
